        ...
        async def shuffle(interaction: discord.Interaction, mode: str):
            ...
            try:
                ...
                if response.status_code != 200:
                    ...
                    await interaction.response.send_message(f"Failed to set shuffle mode: {response.text}")
                    return
                ...
                await interaction.response.send_message(f"Failed to set shuffle mode: {e}")
            except Exception as e:
        ...
        async def repeat(interaction: discord.Interaction, mode: int):
            ...
            try:
                ...
                if response.status_code != 200:
                    ...
                    await interaction.response.send_message(f"Failed to set repeat mode: {response.text}")
                    return
                ...
                await interaction.response.send_message(f"Failed to set repeat mode: {e}")
            except Exception as e:
